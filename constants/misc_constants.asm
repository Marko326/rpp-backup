...
; Status screen packed state (wStatusScreenPage)
DEF STATUS_SCREEN_PAGE_MASK EQU %00000011
DEF STATUS_SCREEN_HIDDEN_PAGE_DIRTY_F EQU 2
DEF STATUS_SCREEN_WIPE_BATCH_MASK EQU %00111000
DEF STATUS_SCREEN_WIPE_ACTIVE_F EQU 6
