; Numeric formatting core moved out of ROM0.
;
; The HOME frontend reads caller-supplied DE data into H_NUMTOPRINT before the
; ROM bank changes. This core therefore never dereferences caller-bank ROMX data.
